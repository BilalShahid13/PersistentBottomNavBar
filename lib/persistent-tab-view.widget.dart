          ...
          ? Stack(
              ...
              children: <Widget>[
                ...
                _navBarHeight == 0
                    ...
                    : Positioned(
                        bottom:
                            (_navBarHeight! - (widget.bottomScreenMargin ?? _navBarHeight! + widget.margin.top)).abs(),
              ...
              ? Stack(
                  ...
                  children: <Widget>[
                    ...
                    _navBarHeight == 0
                        ? SizedBox.shrink()
                        : Positioned(
                            bottom: (_navBarHeight! - (widget.bottomScreenMargin ?? _navBarHeight! + widget.margin.top))
                                .abs(),
                            child: GestureDetector(
                              onTap: () {
                                if (widget.items![(widget.items!.length / 2).floor()].onPressed != null) {
