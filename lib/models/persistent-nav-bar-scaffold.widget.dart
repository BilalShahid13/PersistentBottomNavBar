...
class _TabSwitchingViewState extends State<_TabSwitchingView> with TickerProviderStateMixin {
  ...
  _initAnimationControllers() {
    if (widget.screenTransitionAnimation!.animateTabTransition) {
      _animationControllers = List<AnimationController?>.filled(widget.tabCount!, null, growable: false);
      _animations = List<Animation<double>?>.filled(widget.tabCount!, null, growable: false);
