...
class BottomNavStyle16 extends StatelessWidget {
  ...
  Widget _buildMiddleItem(final BuildContext context, final PersistentBottomNavBarItem item,
      final bool isSelected, final double? height) => navBarEssentials!.navBarHeight == 0
        ? const SizedBox.shrink()
        : Padding(
            padding: EdgeInsets.only(
    ...
    return SizedBox(
      ...
      child: Stack(
        children: <Widget>[
          ...
          if (navBarEssentials!.navBarHeight == 0) const SizedBox.shrink() else Center(
                  child: GestureDetector(
                      onTap: () {
