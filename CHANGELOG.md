...
## [5.0.0] - 2022-03-02
- Republish package to [persistent_bottom_nav_bar_v2](https://pub.dev/packages/persistent_bottom_nav_bar_ccc)
- Respect background color parameter in _TabSwitchingViewState
- Remove unless blob in the publish package
